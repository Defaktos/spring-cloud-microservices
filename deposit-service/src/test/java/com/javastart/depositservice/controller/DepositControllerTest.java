...
public class DepositControllerTest {
    ...
    public void createDeposit() throws Exception {
        ...
        List<Deposit> deposits = depositRepository.findDepositsByEmail("vanilaaabear@mail.ru");
    ...
    private AccountResponseDTO createAccountResponseDTO() {
        ...
        accountResponseDTO.setEmail("vanilaaabear@mail.ru");
        accountResponseDTO.setName("Dima");
        accountResponseDTO.setPhone("89133040503");
